...
cc	DIMENSION P(51)
cc	DIMENSION CC(51)
      DIMENSION C(MH+1,MH+1),C1((MH+1)*2),S1((MH+1)*2)
      DIMENSION CL(MH+1,MH+1),SL(MH+1,MH+1)
      DIMENSION CA1(MH+1,MH+1),CA2(MH+1,MH+1)
      DIMENSION P1(MH+1),P2(MH+1),Q(MH+1)
      DIMENSION CC(MH+1)
      DIMENSION CC0(MH+1),C0(MH+1,MH+1)
      DIMENSION A(MH+1,MH+1),BR(MH+1,MH+1),BI(MH+1,MH+1)
C
...
cc	STOP
    ...
    1 FORMAT(16I5)
    2 FORMAT(4D20.10)
  130 FORMAT(1H ,'PROGRAM 74.6.2. BISPEC / BISPECTRUM COMPUTATION.')
  180 FORMAT(//1H ,4X,'C(I,J): THIRD ORDER MOMENTS'/)
  129 FORMAT(1H ,'N=',I5,5X,'MH=',I5)
  160 FORMAT(/1H ,'REAL PART OF BISPECTRUM B(I,J)'/)
  161 FORMAT(/1H ,'IMAGINARY PART OF BISPECTRUM B(I,J)'/)
  163 FORMAT(1H ,'CC(I):',1X,'AUTOCOVARIANCES')
  165 FORMAT(1H ,I5,D16.5)
      END
C
...
cc	DIMENSION CL(51,51),CA(51,51)
      DIMENSION CL(MH+1,MH+1),CA(MH+1,MH+1)
      CST2=2.0D-00
      CST4=4.0D-00
      CST4I=1.0D-00/CST4
      L1=MH+1
...
cc	DIMENSION CA(51,51),CB(51,51)
      DIMENSION CA(MH+1,MH+1),CB(MH+1,MH+1)
...
cc	DIMENSION CB(51,51),CD(51,51)
      DIMENSION CB(MH+1,MH+1),CD(MH+1,MH+1)
      DIMENSION B(0:MH,0:MH)
      CST2=2.0D-00
      CST4=4.0D-00
      CST4I=1.0D-00/CST4
      CZ=0.0D0
...
cc	DIMENSION CL(51,51),SL(51,51),P(51)
      DIMENSION CL(MH+1,MH+1),SL(MH+1,MH+1),P(MH+1)
      DIMENSION A(0:MH,0:MH)
      L1=MH+1
      H = MH
      CZ =0.0D-00
cc	WRITE(6,185)
...
cc	WRITE(6,186) RAT
      RETURN
  181 FORMAT(1H ,2I5,D17.5)
  185 FORMAT(/1H ,'Q1(I,J)=(CL(I,J)**2+SL(I,J)**2)/(P(I)P(J)P(I+J)MH);',
     1'A MESURE OF COHERENCE BETWEEN X(I)*X(J) AND X(I+J)'/)
  186 FORMAT(/1H ,'APPROXIMATE EXPECTED VALUE OF Q1(I,J) UNDER ',
     A	     'GAUSSIAN ASSUMPTION;',D17.5,'.')
      END
C
...
cc	DIMENSION A1(10),A2(10)
      DIMENSION CXX(LAGH1),FC(LAGH1),P1(LAGH1),P2(LAGH1),Q(LAGH1)
      DIMENSION A1(2),A2(3)
...
cc	CALL PRCOL3(P1,P2,Q,1,LAGH1,1)
      RETURN
   63 FORMAT(1H ,'WINDOW W1',5X,'A(0)=',F10.5,5X,'A(1)=',F10.5)
   64 FORMAT(1H ,'WINDOW W2',5X,'A(0)=',F10.5,5X,'A(1)=',F10.5,5X,'A(2)=
     1',F10.5)
