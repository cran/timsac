...
cc	CALL FLCLS3(NFL)
  ...
  800 FORMAT(2I5)
  801 FORMAT(2F10.5)
  900 FORMAT(1H ,' PROGRAM 74.1.3. COVGEN: L=',I5,5X,'K=',I5/1H )
  901 FORMAT(1H ,' FREQUENCY(',F10.5,')',20X,'DESIRED GAIN = ',F10.5)
  902 FORMAT(//1H ,20X,'AUTO COVARIANCE',25X,
     *'AUTO COVARIANCE NORMALIZED')
  903 FORMAT(1H ,'LAG =',I5,5X,D20.10,31X,D20.10)
  904 FORMAT(4D20.10)
      END
