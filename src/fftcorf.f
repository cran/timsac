...
c      DIMENSION XS(2048),YS(2048)
      DIMENSION X1(LD),Y1(LD),XA(N,2),X(N),Y(N)
	DIMENSION Z(N),ZS(N/2+1)
      DIMENSION CNA1(LAGH1,2),CN1(LAGH1),CN2(LAGH1),AMEAN(2)
