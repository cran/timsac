...
c      DIMENSION X(101,10,10)                                            
      DIMENSION C(LAGH1),S(LAGH1),G(LAGH1),CV(LAGH3,K,K)
      DIMENSION FC(LAGH1),FS(LAGH1)
      DIMENSION P1(LAGH1,K,K),P2(LAGH1,K,K),PS(LAGH1,K)
      DIMENSION PCH1(LAGH1,K,K),PCH2(LAGH1,K,K)
      DIMENSION A1(2),A2(3)
      DIMENSION P(LAGH1*2*K)
C
...
C     LA1: DIMENSION OF A (LESS THAN 11)
      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION FC(LAGH1),FS(LAGH1),P1(LAGH1),P2(LAGH1)
      DIMENSION A(LA1)
      DIMENSION FC1(521),FS1(521)
      LA=LA1-1
      LAGSHF=LAGH1+2*LA
...
C     THIS SUBROUTINE COMPUTES SIMPLE COHERENCE.
      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION P1(LAGH1),P2(LAGH1),C(LAGH1),S(LAGH1),P3(LAGH1)
      DO 10 I=1,LAGH1
   10 P3(I)=(P1(I)**2+P2(I)**2)/(C(I)*S(I))
      RETURN
      END SUBROUTINE
