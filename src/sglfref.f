...
c      DIMENSION R(501),PH(501),P(10,10)
      DIMENSION P11(LAGH1),P22(LAGH1),C(LAGH1),S(LAGH1)
	DIMENSION CP11(LAGH1),CP22(LAGH1),CC(LAGH1),CS(LAGH1)
      DIMENSION R(LAGH1),PH(LAGH1),P(LAGH1,IP,IP)
...
C     (SINGLE CHANNEL)
      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION C(LAGH1),S(LAGH1),ARC(LAGH1)
      PI=3.1415926536
      CST5=0.5D-00
      DO 10 I=1,LAGH1
cc      IF(C(I)) 11,12,13
...
C     (SINGLE CHANNEL)
      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION C(LAGH1),S(LAGH1),PH(LAGH1)
c      DIMENSION ARC(501)
      DIMENSION ARC(LAGH1)
