...
cc	DIMENSION DFORM(20)
      DIMENSION X(N),X1(N),CC(MH+1),CN(MH+1),C(MH+1,MH+1)
      DIMENSION XX(N)
cc	DATA IIND / 7*4HJ=   /
C
...
cc  999 CONTINUE
    ...
    1 FORMAT(16I5)
    2 FORMAT(4D20.10)
   49 FORMAT(1H ,'PROGRAM 74.6.1. THIRMO')
   50 FORMAT(1H ,'THIRD ORDER MOMENTS COMPUTATION')
   51 FORMAT(/1H ,'INITIAL CONDITION')
   52 FORMAT(/1H ,'N=',I5,5X,'MH=',I5)
   53 FORMAT(/1H ,'ORIGINAL DATA')
   55 FORMAT(5(F13.4,' (',I5,'), '))
 1162 FORMAT(///1H ,'AUTOCOVARIANCE')
cc  162 FORMAT(1H ,'N=',I5,5X,'MH=',I5,5X,'MEAN=',E15.5)
  162 FORMAT(/1H ,'N=',I5,5X,'MH=',I5,5X,'MEAN=',D15.5)
  163 FORMAT(/1H ,4X,'I',6X,'CC(I)=E(X(T+I)X(T))',6X,'NORMALIZED')
  180 FORMAT(///1H ,'C(I,J)=E(X(T+I)X(T+J)X(T))')
  181 FORMAT(1H ,2I5,D17.5)
  155 FORMAT(1H ,I5,D17.5,8X,D17.5)
  190 FORMAT(/1H ,7X,7(6X,A2,I5,4X))
  191 FORMAT(1H ,'I=',I5,7D17.5)
  192 FORMAT(1H ,7X,7D17.5)
      END
