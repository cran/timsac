...
cc	DIMENSION X1(100,5)
      DIMENSION SD1(IR,IR),SD(IR,IR),Y(IR),Z(IR)
      DIMENSION X1(MJ0,IR),X2(IR,NRA)
...
ccc   20 SUM=SUM+RANDM(0)
   20 SUM=SUM+RANDM(0,K1,K2,K3,K4)
	 SUM=SUM-4.5D-00
   15 X1(II,J)=SUM*RCONST
   14 CONTINUE
...
cc  999 CONTINUE
    ...
    2 FORMAT(4D20.10)
    3 FORMAT(6D12.3)
   60 FORMAT(1H ,27HPROGRAM 5.5.3   WHITE NOISE)
   61 FORMAT(1H ,17HINITIAL CONDITION)
   62 FORMAT(1H ,4HNRA=,I5,5X,2HN=,I5,5X,2HM=,I5,5X,3HIR=,I5)
   63 FORMAT(/1H ,7HSD(I,J))
  100 FORMAT(////1H ,11HWHITE NOISE)
  101 FORMAT(1H ,4HIIC=,I5,5X,11HX1(IIC+I,J))
      END
